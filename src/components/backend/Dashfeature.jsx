        ...
        <Link to="savemore">
           <div className='flex sm:flex-row flex-col gap-[40px]'>
            ...
            <div className=' border-b-2'> 
                ...
                <p className='mt-1 font-aeroport text-[#21A3AA] font-normal text-2xl mb-[30px] '>Only pay for the space you need and avoid<br/> costly removal fees. Save up to 40%!</p>
            </div>
           </div>
           </Link>
            <Link to="ultimate">
           <div className='flex sm:flex-row flex-col gap-[40px] mt-6'>
            ...
            <div className=' border-b-2'> 
                ...
                <p className='mt-1 text-2xl text-[#21A3AA] font-aeroport font-normal mb-[30px] '>Forget heavy lifting and moving hassles.<br/>We save you hours of effort.</p>
            </div>
           </div>
           </Link>
...
<Link to="flexible">
           <div className='flex sm:flex-row flex-col gap-[40px] mt-6'>
            ...
            <div className=' border-b-2'> 
                ...
                <p className='mt-1 text-2xl text-[#21A3AA] mb-[30px] font-aeroport font-normal '>Need more or less space? No problem!<br/> Our plans adapt to your needs.</p>
            </div>
           </div>
           </Link>
        </div>
