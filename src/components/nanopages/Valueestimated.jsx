...
function Valueestimated() {
  ...
  return (
    ...
    <div className=''>
        ...
        <div className='grid lg:grid-cols-2 justify-items-center mb-4 font-aeroport  h-[400px] overflow-scroll'>
         {/**add from here */}
         {["Mini", "Mini", "Mini",  "Mini",  "Mini",  "Mini"].map((item, index) => (
                        <div key={index} className={`flex flex-col sm:w-[459px] w-[280px] ${openTabIndex === index ? 'h-auto' : 'h-[107px]'} justify-between border-2 mt-3 px-[17px]`}>
                                    ...
                                    <div className="flex md:flex-row flex-col items-center mt-4 gap-4 mb-3" role="none">
                                        ...
                                        <div className='w-[136px] h-[250px] border-2 rounded-xl overflow-hidden'>
                                            ...
                                            <div className='text-center font-aeroport mt-3 px-1'>
                                                ...
                                                <p className='font-normal text-sm'>Stay 6 months or more and save!
                                                    20% discount on monthly storage
                                                    Initial Collection At No Cost
                                                </p>
                                            </div>
                                        </div>
