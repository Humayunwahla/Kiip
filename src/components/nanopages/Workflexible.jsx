...
function Workflexible() {
  return (
    <div>
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 2xl:px-[69px] mx-10 sm:px-[40px] px-[3px] mt-10  '>
        <div className='flex  flex-col sm:gap-[40px] gap-[10px] '>
            ...
            <div className=' '>
                <div  className='flex flex-row gap-2'>
                  ...
                  width={35}
                  height={35} />
                <h2 className='font-bold text-4xl font-aeroport'>Select items</h2>
            </div>
                <p className='mt-1 font-semibold font-aeroport text-lg leading-6 mb-[45px] '>Select items you want to store away and <br/>schedule a visit on the day and time that<br/>uits you best</p>
                </div>
           </div>
