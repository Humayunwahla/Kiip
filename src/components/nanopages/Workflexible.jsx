        ...
        <div className='flex  flex-col sm:gap-[40px] gap-[10px] '>
           ...
           <div className='flex  flex-col sm:gap-[40px] gap-[16px] lg:mt-48 mt-6 lg:ml-28'>
            ...
            <div  className='flex flex-row gap-2'>
                ...
                <p className='mt-1 font-semibold font-aeroport sm:text-lg leading-6 mb-[45px] '>We collect your items from any location you<br/> specify, protect them during transport, and<br/>handle everything with care.</p>
            </div>
           </div>
           ...
           <div className='flex flex-col sm:gap-[40px] gap-[16px] mt-6'>
            ...
            <div  className='flex flex-row gap-2'>
                ...
                <p className='mt-1 leading-6 font-semibold font-aeroport sm:text-lg mb-[45px] '>Your belongings are important to us. They<br/>are monitored 24/7, allowing you to relax<br/>and enjoy your home, family, or trip.</p>
            </div>
           </div>
           ...
           <div className='flex  flex-col sm:gap-[40px] gap-[16px] lg:mt-48 mt-6 lg:ml-28'>
            ...
            <div  className='flex flex-row gap-2'>
                ...
                <p className='mt-1 leading-6 font-semibold sm:text-lg mb-[45px] font-aeroport '>With a click, select the items you need from <br/>your inventory, and we'll deliver them to you<br/>wherever and whenever you want.</p>
            </div>
           </div>
        </div>
        </div>
