  ...
  return (
    <div className=' p-[3px]'>
        <div className='background2 '>
            ...
            <p className='text-center font-aeroport font-normal mt-3'>We handle everything for you we pick up, store, and deliver<br/> your belongings whenever you need them.</p>
            <Link to="quote">
